...
const NotFound = () => {
    return (
        <div className="font-stencil bg-black flex items-center justify-center h-screen text-white flex-col space-y-7">
            <h1 className="lg:text-6xl md:text-3xl sm:text-xl xs:text-center">Sorry.The page you browsed is not available.</h1>
            <img src="/not-found.jpg" alt="page not found" className="lg:w-96 lg:h-96 md:w-96 md:h-96 sm:w-84 sm:h-84 bg-transparent xs:w-44 xs:h-44" />
