...
const FitnessStory: React.FC<FitnessStoryProps> = ({ storyNumber, description, image }) => {
  ...
  return (
    <motion.div className="flex flex-row items-center justify-between mb-16 relative" ref={ref} style={{opacity:opacity,y:translateY}} transition={{duration:1.5,ease:'easeInOut'}}>
      {/* Large Number */}
