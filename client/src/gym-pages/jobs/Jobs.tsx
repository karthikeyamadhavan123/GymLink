  ...
  return (
    <div className="min-h-screen bg-black text-white font-stencil">
      <Helmet>
        ...
        <meta
          name="description"
          content="Find the best fitness jobs and career opportunities in the wellness industry. Apply to trainer, instructor, and management positions at top gyms."
        />
        <meta
          name="keywords"
          content="fitness jobs, gym careers, personal trainer jobs, fitness instructor"
        />

        {/* Open Graph Tags */}
        <meta
          property="og:title"
          content="All Fitness Jobs & Careers | GymLink"
        />
        <meta
      ...
      <div className="bg-gradient-to-r from-black to-gray-900 text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl mb-8">
            Discover opportunities at top gyms and fitness centers
          </p>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <span className="text-gray-300">
                      ...
                      {job.experienceRequired === 1 ? "year" : "years"}{" "}
                      experience required
                    </span>
                  </div>
      ...
      {notificationModal && <Notifications setstate={setNotificationModal} />}
      {error && (
        <h1 className="text-red-400 font-bold text-3xl text-center">{error}</h1>
      )}
    </div>
  );
};
