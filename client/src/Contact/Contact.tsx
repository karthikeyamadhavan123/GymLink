...
export default function Contact() {
    return (
        <>
            <Helmet>
                <title>Contact GymLink - Get in Touch</title>
                <meta name="description" content="Need help or have questions? Contact GymLink and our support team will assist you with gym listings, trainer inquiries, and more." />
                <meta name="keywords" content="Contact GymLink, support, help, gym inquiries, trainers, customer service" />
                <link rel="canonical" href="https://gymlink.com/contact" />
            </Helmet>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                        ...
                        <div className="lg:col-span-3 bg-white p-6 rounded-lg shadow-md">
                            ...
                            <form>
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-lime-300 cursor-pointer hover:bg-teal-600 text-white font-medium py-2 px-4 rounded-md transition duration-300"
                                >
                                    Send Message
                                </button>
                            </form>
