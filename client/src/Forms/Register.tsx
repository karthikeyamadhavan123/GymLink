    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Create your GymLink account and start your fitness journey today!" />
                <meta name="keywords" content="GymLink, fitness, register, sign up, gym membership" />
